...
namespace HBS.HairBySilke_2021.DataAccess
{
    public class DbSeeder: IMainDbSeeder
    {
        ...
        private TreatmentEntity[] GetTreatments()
        {
            ...
            treatmentEntities.Add(new TreatmentEntity {TreatmentName = "Dameklip", Price = 325, Duration = 60});
            treatmentEntities.Add(new TreatmentEntity {TreatmentName = "Bundfarve", Price = 415, Duration = 120});
            treatmentEntities.Add(new TreatmentEntity {TreatmentName = "Helfarve", Price = 500, Duration = 120});
            ...
            treatmentEntities.Add(new TreatmentEntity
                {TreatmentName = "Balayage + Bundfarve", Price = 1075, Duration = 120});
            ...
            treatmentEntities.Add(new TreatmentEntity
                {TreatmentName = "Striber - Skulderlangt hår", Price = 630, Duration = 120});
            treatmentEntities.Add(new TreatmentEntity
                {TreatmentName = "Striber - Langt hår", Price = 775, Duration = 120});
            treatmentEntities.Add(new TreatmentEntity
                {TreatmentName = "Permanent - kort hår", Price = 575, Duration = 120});
            treatmentEntities.Add(new TreatmentEntity
                {TreatmentName = "Permanent - Skulderlangt hår", Price = 755, Duration = 120});
            treatmentEntities.Add(new TreatmentEntity
                {TreatmentName = "Permanent - Langt hår", Price = 875, Duration = 120});
            treatmentEntities.Add(new TreatmentEntity
                {TreatmentName = "Bryn retning m. blad", Price = 20, Duration = 10});
            treatmentEntities.Add(new TreatmentEntity
                {TreatmentName = "Bryn retning m. pincet", Price = 50, Duration = 10});
            treatmentEntities.Add(new TreatmentEntity {TreatmentName = "Bryn farve", Price = 50, Duration = 120});
            treatmentEntities.Add(new TreatmentEntity
                {TreatmentName = "Bryn farve + retning", Price = 85, Duration = 120});
            treatmentEntities.Add(new TreatmentEntity {TreatmentName = "Vipper farvning", Price = 85, Duration = 15});
            treatmentEntities.Add(new TreatmentEntity {TreatmentName = "Bryn + vipper", Price = 150, Duration = 60});
            treatmentEntities.Add(new TreatmentEntity {TreatmentName = "Kurbehandling", Price = 150, Duration = 15});
            treatmentEntities.Add(new TreatmentEntity {TreatmentName = "Hverdagsmakeup", Price = 300, Duration = 60});
            treatmentEntities.Add(new TreatmentEntity {TreatmentName = "Festmakeup", Price = 450, Duration = 30});
            treatmentEntities.Add(new TreatmentEntity {TreatmentName = "Bryllupsmakeup", Price = 550, Duration = 60});
            treatmentEntities.Add(new TreatmentEntity {TreatmentName = "Herreklip", Price = 245, Duration = 60});
            treatmentEntities.Add(new TreatmentEntity {TreatmentName = "Skægklip", Price = 150, Duration = 60});
            treatmentEntities.Add(new TreatmentEntity {TreatmentName = "Glatbarbering", Price = 150, Duration = 60});
